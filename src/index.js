...
class DatePicker extends React.Component {
    ...
    constructor(props) {
        ...
        todayDate = moment((todayDate.getFullYear() + '/' + (todayDate.getMonth() + 1) + '/' + todayDate.getDate()))
        this.state = {
            mode: props.mode == 'birthdate' ? 'year' : 'day',
            day: (props.date && props.date.day) ? props.date.day : todayDate.jDate(),
            month: (props.date && props.date.month) ? props.date.month : todayDate.jMonth() + 1,
            year: (props.date && props.date.year) ? props.date.year : todayDate.jYear(),
            firstDayOfMonthWeekDay: 0,
            startYear: props.mode == 'birthdate' ? todayDate.jYear() - 20 : todayDate.jYear() - 2,
            picker: 'date'
        };
    ...
    getDate = () => {
        ...
        return { year: this.state.year, month: this.state.month, day: this.state.day }
    }
    onNextClick = () => {
    ...
    onTodayClick = () => {
        ...
        this.setState({ year: todayDate.jYear(), month: todayDate.jMonth() + 1, day: todayDate.jDate() }, () => {
            this.computeMonthDaysArrangment()
            ...
            <div className="BBDatePicker">
                <div className="datepicked">
                    ...
                    <div className="toolbox">
                        <div className="pwt-btn-today" onClick={this.onTodayClick}>امروز</div>
                    </div>
                </div>
                {this.state.picker === 'date' && <div className="datepicker-plot-area  datepicker-state-no-meridian  ">
                    ...
                    <div data-navigator="" className="datepicker-navigator">
                        ...
                        {this.state.mode === 'month' && <div onClick={this.onYearPickerClick} 
                        className="pwt-btn pwt-btn-switch">{this.state.year} </div>}
                    ...
                    <div className="datepicker-grid-view">
                        <div className="datepicker-day-view">
                            <div className="month-grid-box">
                                ...
                                {this.state.mode === 'year' && <YearPicker date={this.getDate()} startYear={this.state.startYear} 
                                onSelectYearClick={this.onSelectYearClick}></YearPicker>}

                                {this.state.mode === 'day' && <DayPicker onSelectLastMonthDayClick={this.onSelectLastMonthDayClick} 
                                getDaysOfLastMonth={this.getDaysOfLastMonth} date={this.getDate()} 
                                firstDayOfMonthWeekDay={this.state.firstDayOfMonthWeekDay}
                                    onSelectDayClick={this.onSelectDayClick} daysOfMonth={this.getDaysOfMonth()}
                                     onSelectNextMonthDayClick={this.onSelectNextMonthDayClick} months={months}></DayPicker>}

                                {this.state.mode === 'month' && <MonthPicker date={this.getDate()} 
                                onSelectMonthClick={this.onSelectMonthClick} months={months}></MonthPicker>}
